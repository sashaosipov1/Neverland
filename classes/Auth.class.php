...
class User
{
    ...
    private $db_host = "188.134.84.134";
    private $db_name = "auth";
    private $db_user = "root";
    private $db_pass = "Gmk45zlM";
    ...
    public function passwordHash($password, $salt = null)
    {
        ...
        $salt || $salt =substr(str_shuffle($permitted_chars), 0, 8); 
    ...
    public function getSalt($username) {
        $query = "select salt from authme_v12 where username = :username limit 1";
    ...
    {
        $query = "select id, username from authme_v12 where
            realname = :username and password = :password limit 1";
        $sth = $this->db->prepare($query);
    ...
    public function create($username, $password) {
        ...
        $query = "insert into authme_v12 (username, realname, password, salt)
            values (:lowusername,:username, :password, :salt)";
    ...
    public function createFeedback($email, $feedback) {
        ...
        $query = "insert into feedbacks (email, feedback)
